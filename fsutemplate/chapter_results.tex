...
\begin{figure}[!htc]
 		\centering
        \subfloat[maximum number of particles equal to number of particles]{\label{fig:fps_num}\includegraphics[scale=0.5]{figures/maxnum_eq_num_fps.png}}
        \\
        \subfloat[maximum number of particles equal to 1 million]{\label{fig:fps_1mill}\includegraphics[scale=0.5]{figures/maxnum_eq_1mill_fps.png}}
        \caption{Frame Rates}
        \label{fig:fps}
\end{figure}
...
\begin{figure}[!htc]
 		\centering
        \subfloat[NVIDIA]{\label{fig:nv_pie}\includegraphics[scale=0.2]{figures/nv_pie.png}}
        \subfloat[AMD]{\label{fig:ati_pie}\includegraphics[scale=0.2]{figures/ati_pie.png}}
